...
public class TypeSystemLanguageParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("TypeSystemLanguage");
  ...
  { 
    TypeSystemLanguageParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = TypeSystemLanguageParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = TypeSystemLanguageParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(TypeSystemLanguageParseControllerGenerated.class);
    }
  ...
  { 
    return TypeSystemLanguageParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
